...
(function () {
    var HelloWorldExperienceProvider = (function () {
        function HelloWorldExperienceProvider(orchestrator, esData) {
            ...
            this.keyword = this.esData.data.message || "Hello World.";
        }
        ...
        HelloWorldExperienceProvider.prototype = {
            load: function (experienceStreamId) {
                ...
                this._uiControl.innerHTML = this.keyword + "  Experience Stream Id = " + experienceStreamId + " loaded";
            },
            // Play contents from the given offset & experienceStreamId
            play: function (offset, experienceStreamId) {
                this._uiControl.innerHTML = this.keyword + "  Experience Stream Id = " + experienceStreamId + " loaded" + "play called at " + offset;
            ...
            pause: function (offset, experienceStreamId) {
                this._uiControl.innerHTML = this.keyword + "  Experience Stream Id = " + experienceStreamId + " loaded" + "pause called at " + offset;
            ...
            onESEvent: function (sender, eventId, eventData) {
                this._uiControl.innerHTML = this.keyword + "  EsEvent has been raised by an Experience Provider";
            },
            // Set the base volume. <Optional>
            setVolume: function (baseVolume) {
                this._uiControl.innerHTML = this.keyword + "  Setting the volume to " + baseVolume;
            },
            // Mute or unmute. <Optional>
            setIsMuted: function (value) {
                this._uiControl.innerHTML = this.keyword + "  Muting the volume";
            },
    ...
    var ELEMENTHTML = '<span style="width:100%;height:20%;position:absolute;color:white;"></span>';
}());
